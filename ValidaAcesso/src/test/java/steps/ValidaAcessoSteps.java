...
public class ValidaAcessoSteps {
	...
	public void clicar_menu() {
		driver.findElement(By.cssSelector(
				"#navigation-menu > div.nav-submenu.panel.layout-column.short > div.gh-item.nav-submenu-label > span"))
				.click();
	...
	public void devo_encontrar_o_título_serviços_de_cloud() {
		...
		assertEquals("Serviços de Cloud", text.getText());
